...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        for(;;)
        {
            try {
                ...
                Logger logInputStation = LogManager.getLogger("enteringStation");
                logInputStation.info("Отправление: " + from);
                Station to = takeStation("Введите станцию назначения:");
                logInputStation.info("Назначения: " + to);
                ...
                Logger logError = LogManager.getLogger("error");
                logError.error("Ошибка" + e.getMessage());
            }
        }
    }
    ...
    private static Station takeStation(String message)
    {
        for(;;)
        {
            ...
            Logger logInputMistake = LogManager.getLogger("mistakeEnteringStation");
            logInputMistake.info("Станция не найдена: " + line);
